...
is(is_reference([]),           1, 'SPM::Util::is_reference array reference returns true');
is(is_reference({}),           1, 'SPM::Util::is_reference hash reference returns true');
...
throws_ok { isnt_defined(sub {}) } "SPM::X::BadValue", 'SPM::Util::isnt_defined code reference throws exception';
...
throws_ok { isnt_reference([])           } "SPM::X::BadValue", 'SPM::Util::isnt_reference array reference throws exception';
throws_ok { isnt_reference({})           } "SPM::X::BadValue", 'SPM::Util::isnt_reference hash reference throws exception';
